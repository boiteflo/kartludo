...
import textQuill from '../../components/textQuill';
  ...
  async mounted(){
    ...
    const sousClasses = serviceDaggerheart.sousClassesNiv1.map(x=> {return {name:x, image:require('@/assets/Daggerheart/Cartes/SousClasses3/' + x +'.png')};});
    const domaines = serviceDaggerheart.domainesNiv1.map(x=> {return {name:x, image:require('@/assets/Daggerheart/Cartes/Domaines3/' + x + '.png' )};});
