<template>
    <div @click="$emit('click', deck)" class="relative cursorHand parentHover"
        style="aspect-ratio: 300/225; width:20%; min-width:150px; max-width: 250px;" >
        ...
        <div id="title" class="bgWhite bgYellowParentHover absolute text-center textVerticalCenter circle15px fontSize075em"
